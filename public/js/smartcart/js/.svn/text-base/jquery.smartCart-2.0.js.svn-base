        ...
        return this.each(function() {
                ...
                $(btCheckout).click(function() {
                   if($.isFunction(options.onCheckout)) {
                      ...
                      options.onCheckout.call(this,elmProductSelected, this);
                   }else{
			 ...
			 var url = '/pricefor/' + qty + '/' + pId;
			  ...
			  $.ajax({
			      ...
			      data: '',
			      async: false,
			      success: function(data) { console.log(data); pPrice = data.price; 
							$(addProduct).attr(attrProductPrice, pPrice);
